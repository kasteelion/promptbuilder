...
def main() -> int:
    ...
    heuristics = [
        ...
        (
            re.compile(r"cocktail|formal|evening|gown|suit|tuxedo|elegant|bridal", re.I),
            "formal",
        ),
        ...
        (
            re.compile(
                r"casual|streetwear|hoodie|jeans|everyday|comfort|yoga|athleisure|street",
                re.I,
            ),
            "casual",
        ),
    ...
    # ensure male/female tag based on Gender line
