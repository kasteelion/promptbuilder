...
**Football jersey** for **{team}** in **{secondary_color} with {primary_color} accents** (performance mesh with number){modifier}; **padded football pants** in **{secondary_color}** (knee-length with secure fit); **football cleats** ({accent}). *Accessories:* **Football Helmet** ({secondary_color}), **shoulder pads** (under jersey), eye black. *Hair/Makeup:* Hair braided and secured, minimal makeup.
