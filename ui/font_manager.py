...
class FontManager:
    ...
    def increase_font_size(self):
        ...
        self.user_adjustment = min(self.user_adjustment + 1, 
                                   MAX_FONT_SIZE - self.base_font_size)
        self._update_fonts()
    ...
    def decrease_font_size(self):
        ...
        self.user_adjustment = max(self.user_adjustment - 1,
                                   MIN_FONT_SIZE - self.base_font_size)
        self._update_fonts()
        self.prefs.set("font_adjustment", self.user_adjustment)
    ...
    def _on_resize(self, event):
        ...
        self._resize_after_id = self.root.after(
            ...
            lambda: self._handle_resize(event.width)
        )
    ...
    def _handle_resize(self, width: int):
        ...
        self._update_fonts()
        logger.debug(f"Font resized: width={width}, base={self.base_font_size}, "
