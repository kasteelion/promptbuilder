...
• Details - Additional visual elements and atmosphere"""
        ...
        # Style name
        ttk.Label(main_frame, text="Style Name:", font=("Segoe UI", 10, "bold")).pack(anchor="w", pady=(0, 4))
        ...
        # Style description
        ttk.Label(main_frame, text="Style Description:", font=("Segoe UI", 10, "bold")).pack(anchor="w", pady=(0, 4))
        ttk.Label(main_frame, text="Define the visual characteristics across all sections", foreground="gray", font=("Segoe UI", 8)).pack(anchor="w")
...
Holographic displays, circuit patterns, rain-slicked atmosphere."""
    ...
    def _create_style(self):
        ...
        # Validate
        if not name:
            messagebox.showerror("Validation Error", "Please enter a style name.", parent=self.dialog)
            return
        
        # Check if still placeholder
        if not description or description.startswith("Rendering\n[Describe"):
            messagebox.showerror("Validation Error", "Please enter a style description.", parent=self.dialog)
            return
